...
final class Uebebiene_Teacher_App {
  public const APP_SLUG = 'uebebiene-teacher';
  public const SETTINGS_OPTION = 'uebebiene_teacher_app_settings';

  private static ?self $instance = null;
  private Uebebiene_Teacher_App_Routes $routes;
  private Uebebiene_Teacher_App_Admin $admin;
  ...
  private function __construct() {
    $this->routes = new Uebebiene_Teacher_App_Routes();
    $this->admin = new Uebebiene_Teacher_App_Admin($this->routes);
